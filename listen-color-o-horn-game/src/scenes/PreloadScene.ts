...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_ItemPen, 'assets/images/S1/pen.png');
        this.load.image(TextureKeys.S1_ItemBox, 'assets/images/S1/box.png');
        this.load.image(TextureKeys.S1_ItemRuler, 'assets/images/S1/ruler.png');
        ...
        this.load.image(TextureKeys.S2_Flag_Outline, 'assets/images/S2/flag_outline.png');
        this.load.image(TextureKeys.S2_Flag_Left, 'assets/images/S2/flag_left.png');
        this.load.image(TextureKeys.S2_Flag_Mid, 'assets/images/S2/flag_mid.png');
        this.load.image(TextureKeys.S2_Flag_Right, 'assets/images/S2/flag_right.png');
