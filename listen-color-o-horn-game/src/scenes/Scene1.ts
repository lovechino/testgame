...
export default class Scene1 extends Phaser.Scene {
    ...
    private createRightPanel() {
        ...
        this.createPuzzleItem(item2X, item2Y, TextureKeys.S1_ItemPen, false);

        // Item 3: thước kẻ (Đúng -> true)
        const item3X = centerX + boardRight.displayWidth * UI.ITEM_OFFSET_X_3; 
        const item3Y = centerY;
        this.createPuzzleItem(item3X, item3Y, TextureKeys.S1_ItemRuler, true);
