...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_Item_1, 'assets/images/S1/item_boys.png');
        this.load.image(TextureKeys.S1_Item_2, 'assets/images/S1/item_mom.png');
        this.load.image(TextureKeys.S1_Item_3, 'assets/images/S1/item_baby.png');
        ...
        this.load.image(TextureKeys.S2_Item_Outline, 'assets/images/S2/lamp_outline.png');
        this.load.image(TextureKeys.S2_Item_1, 'assets/images/S2/lamp_1.png');
        this.load.image(TextureKeys.S2_Item_2, 'assets/images/S2/lamp_2.png');
        this.load.image(TextureKeys.S2_Item_3, 'assets/images/S2/lamp_3.png');
