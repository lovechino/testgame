...
export default class Scene1 extends Phaser.Scene {
    ...
    private createLeftPanel() { 
        ...
        const poemText = this.add.image(centerX, poemY, TextureKeys.S1_PoemText)
            .setScale(0.7).setOrigin(0.65, 1).setInteractive({ useHandCursor: true });
    ...
    private createRightPanel() {
        ...
        this.createPuzzleItem(item1X, item1Y, TextureKeys.S1_Item_1, false);
        ...
        this.createPuzzleItem(item2X, item2Y, TextureKeys.S1_Item_2, true);
