...
export const GameConstants = {
    ...
    IDLE: {
        ...
        FADE_OUT: 500,
        /** Bàn tay xuất phát từ đâu so với điểm hint (px)
         * Âm = trái, Dương = phải
         * Bàn tay sẽ di chuyển từ vị trí này về điểm hint
         */
        OFFSET_X: 100,
        /** Bàn tay xuất phát từ đâu so với điểm hint (px)
         * Âm = trên, Dương = dưới
         ...
         */
        OFFSET_Y: -100,
        /** Offset tâm bàn tay so với điểm hint (px) - Với logic destX = targetX + offset
         * Ngón tay trỏ nằm ở góc TRÊN-TRÁI của hình ảnh bàn tay.
         * Để ngón trỏ vào ĐÚNG điểm target, tâm bàn tay phải nằm DƯỚI-PHẢI của điểm target.
         * Do đó dùng giá trị dương để đẩy tâm bàn tay sang phải và xuống dưới.
         */
        TIP_OFFSET_X: 80,
        TIP_OFFSET_Y: 80,
    },
    ...
    SCENE1: {
        ...
        TIMING: {
             ...
             *  Đặt 0 để bắt đầu đếm ngay sau khi đọc xong → đúng 10s (IDLE.THRESHOLD) không chọn thì hiện gợi ý */
            DELAY_IDLE: 0,
