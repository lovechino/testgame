...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_Item_1, 'assets/images/S1/item_pant.png');
        this.load.image(TextureKeys.S1_Item_2, 'assets/images/S1/item_feet.png');
        this.load.image(TextureKeys.S1_Item_3, 'assets/images/S1/item_hands.png');
