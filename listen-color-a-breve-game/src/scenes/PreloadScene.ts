...
export default class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image(TextureKeys.S1_Item_1, 'assets/images/S1/item_towel.png');
        this.load.image(TextureKeys.S1_Item_2, 'assets/images/S1/item_soap.png');
        this.load.image(TextureKeys.S1_Item_3, 'assets/images/S1/item_book.png');
        ...
        this.load.image(TextureKeys.S2_A_Hat, 'assets/images/S2/a_hat.png');
        
        this.load.image(TextureKeys.S2_Towel_Outline, 'assets/images/S2/towel_outline.png');
        this.load.image(TextureKeys.S2_Towel_1, 'assets/images/S2/towel_1.png');
        this.load.image(TextureKeys.S2_Towel_2, 'assets/images/S2/towel_2.png');
        this.load.image(TextureKeys.S2_Towel_3, 'assets/images/S2/towel_3.png');
        this.load.image(TextureKeys.S2_Towel_4, 'assets/images/S2/towel_4.png');
        this.load.image(TextureKeys.S2_Towel_5, 'assets/images/S2/towel_5.png');
